class SongsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @song.save
        format.html { redirect_to @song, notice: "Song successfully added." }
  ...
  private
    ...
    def song_params
      params.require(:song).permit(:name, :artist, :genre, :user_id, :country, :length, :style, :release_date )
    end
end
